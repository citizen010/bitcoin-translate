...
- [ ] Alice decide di inviare (ovvero effettuare una [transazione](glossario.md#transazione)) a Bob un bitcoin (1 BTC)
- [ ] Bob fornisce ad Alice un indirizzo bitcoin che lui controlla 
